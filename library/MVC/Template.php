...
';
	...
	<body>
		<header>
	        <div id="logo">
	            <a href="'.URL_APP.'">
	                <img src="public/pictures/logos/muonium_H_01.png" title="'.Controller::$txt->Global->home.'" alt="'.Controller::$txt->Global->home.'">
	            </a>
	        </div>
	        <div id="language-selector">
	            '.Controller::getLanguageSelector().'
	        </div>
		';
		if(isset($_SESSION['id'])) {
			$html .= '<a href="Logout" class="logout" title="'.Controller::$txt->Global->logout.'"><i class="fa fa-sign-out" aria-hidden="true"></i></a>';
		}
	    $html .= '
		</header>
		<div id="main">
